...
TEST(displayTests, botOutputTest)
{
  ...
  ASSERT_TRUE(testBot->randomAction(true));
...
// TEST(GameHandlerTests, BotGameTest) {                            //SEG FAULT
...
// TEST(GameHandlerTests, NotBotGameTest) {                                   //SEG FAULT
...
// TEST(GameHandlerTests, NoMoreRoundsTest)         //INPUT ISSUE?
// {
...
// TEST(GameHandlerTests, GameWinnerTest)           //INPUT ISSUE?
// {      
//   ostringstream out;
